...
Located at: `/phoenix_kit/admin/referral-codes`

#### Features:
- **Code List**: Table view of all codes with status indicators
- **Create Code**: Form with code generation options
- **Edit Code**: Modify existing code parameters
