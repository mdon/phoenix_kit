defmodule PhoenixKit.Migrations.Postgres.V201 do
  @moduledoc """
  V201: A user's view preferences, per view.
  ...
  def up(opts) do
    ...
    execute("COMMENT ON TABLE #{p}phoenix_kit IS '201'")
  end

  @doc "Rolls V201 back: drops the table. Every saved view preference is lost."
  def down(opts) do
    prefix = Map.get(opts, :prefix, "public")
    p = prefix_str(prefix)
