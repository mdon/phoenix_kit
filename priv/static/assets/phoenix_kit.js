...
// ============================================================================
// FRESCO + TESSERA + ETCHER — bundled from deps so parent apps get the
// hooks via window.PhoenixKitHooks without having to wire them separately.
// Refresh these by copy-pasting the latest priv/static/{fresco,tessera,etcher}.js
// from the dep source. Each IIFE self-guards via window.{Lib}Loaded so
// importing the standalone lib alongside this bundle is harmless.
// ============================================================================
...
// ----- Bridge: merge Fresco + Tessera + Etcher hooks into PhoenixKitHooks -----
(function() {
